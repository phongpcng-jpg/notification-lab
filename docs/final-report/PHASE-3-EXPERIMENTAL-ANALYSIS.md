# Phase 3 — Experimental Analysis (A–G)

> **Evidence status:** This document interprets the completed A–G benchmark results supplied from `benchmark/results/processed/`. It does not replace the generated result matrix. Numerical values below are the observed aggregate values used for the Phase 3 analysis.

## 1. Purpose

Phase 3 converts the A–G measurements into technical findings while keeping three things separate:
